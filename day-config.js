...
window.WHYDAH_FORCE = null; /* Automatic: banner picks today's entry by date (Eastern time). Set to a day number only to force one day for everyone. */
...
window.WHYDAH_DAYS = [
  ...
  /* Renumbered 2026-07-29: the inserted studio day IS Day 15 to the kids,

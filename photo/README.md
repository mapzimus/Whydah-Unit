...
| `submit.html` | `/photo/submit.html` | **Showcase submission.** Each student gets three slots. Add a photo + caption per slot; **Replace**, **Update caption**, or **Delete** anytime if they uploaded the wrong one. |

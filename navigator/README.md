...
On top of that, every run draws **four random mutators** (cheese coins, watching gulls, big head, bouncy, **pug in the rug**, confetti, rubber squeaks, **parrots**, **squawk**) and every leg spins a chaos modifier — with a ~1-in-3 chance of **double chaos**. New chaos: parrot storm, cracker rain, rainbow broadsides, poltergeist helm. The enemy fleet can roll a **Very Loud Parrot**, pug-in-rug, lobster, whale, UFO, duck, crab, snowman, or toaster. Bosses are shootable the whole fight. The Cape Cod serpent is **the Sea Pug**; the finale is **PUGNAROK**. Multiverse cards now include more **3-way choices** (parrot jury, Polly wants…, parrot mutiny, and more). Easy/Hard/Extreme stay untouched.
...
- v9.2 ("Play the sea"): classroom gameplay pass — touch up/down helm, Space advances Port/Merchant/Harbor, election ←/→, storm win reject toast, graze/blast teach, Gulf Stream sprint before the fork, Cape Cod prep before the Blockade, painted broadside gaps, Blockade barrel + Extreme de-stack, guaranteed merchant, escalating nav minis, Palatine debris wake. DiveScene removed. August 2026.

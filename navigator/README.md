...
- **A lively sea.** Between fights the water is busy with things worth grabbing — coins, drifting coin arcs, **cargo crates** (📦 +20 gold), bottles, wind, and repair barrels — on a steady pickup stream that's separate from the hazard stream, so the sea can be full without being deadly. Hearts drift by when you're hurt.

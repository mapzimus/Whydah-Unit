...
- **Four difficulties.** **EASY** (an extra heart, gentler seas), **HARD** (the classic tuning), **EXTREME** (tougher ships, a longer storm, a score bonus), and **🌀 INSANE** — unlocked by beating EXTREME **or** the secret word.

...
On top of that, every run draws **three random mutators** (coins as cheese wheels, watching gulls, big head mode, everything's bouncier, **pug in the rug**, confetti hits, rubber squeaks) and every leg spins a chaos modifier (low gravity, a speed run, a tiny ship, mirrored steering, disco seas, upside-down gulls, everything's legally a crab, sudden night, **flying pug rugs**, spinning ship, everything's huge). The enemy fleet stops being ships entirely — battles roll a **Pug in the Rug**, lobster, whale, UFO, rubber duck, crab-with-sword, snowman, or toaster. Bosses are **actually shootable** the whole fight (generous hit rings, FIRE cues, Sharknado column always takes shot, Kraken has a beak you can sink). The Cape Cod serpent becomes **the Sea Pug** (tennis-ball venom, a "BOOP!" when it lunges), and the last boss becomes **PUGNAROK, the three-headed good boy**. Multiverse-only logbook cards — including *A pug in the rug* — round it out. Easy/Hard/Extreme are completely untouched — the chaos is opt-in.
